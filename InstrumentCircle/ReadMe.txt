========================================================================
		ActiveX Control DLL : INSTRUMENTCIRCLE
========================================================================

ControlWizard has created this project for your INSTRUMENTCIRCLE ActiveX Control
...
that make up your INSTRUMENTCIRCLE ActiveX Control DLL.

InstrumentCircle.dsp
...
InstrumentCircle.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
InstrumentCircle control:

InstrumentCircleCtl.h
	This file contains the declaration of the CInstrumentCircleCtrl C++ class.

InstrumentCircleCtl.cpp
	This file contains the implementation of the CInstrumentCircleCtrl C++ class.

InstrumentCirclePpg.h
	This file contains the declaration of the CInstrumentCirclePropPage C++ class.

InstrumentCirclePpg.cpp
	This file contains the implementation of the CInstrumentCirclePropPage C++ class.

InstrumentCircleCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CInstrumentCircleCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file InstrumentCircle.rc.
