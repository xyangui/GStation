========================================================================
		ActiveX Control DLL : INSTRUMENTPANEL
========================================================================

ControlWizard has created this project for your INSTRUMENTPANEL ActiveX Control
...
that make up your INSTRUMENTPANEL ActiveX Control DLL.
...
/////////////////////////////////////////////////////////////////////////////
InstrumentPanel control:

InstrumentPanelCtl.h
	This file contains the declaration of the CInstrumentPanelCtrl C++ class.

InstrumentPanelCtl.cpp
	This file contains the implementation of the CInstrumentPanelCtrl C++ class.

InstrumentPanelPpg.h
	This file contains the declaration of the CInstrumentPanelPropPage C++ class.

InstrumentPanelPpg.cpp
	This file contains the implementation of the CInstrumentPanelPropPage C++ class.

InstrumentPanelCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CInstrumentPanelCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file InstrumentPanel.rc.
